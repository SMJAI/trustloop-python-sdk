...
tl = Navige(api_key="tl_your_key_here", agent_name="langchain-research-agent")
...
# Wrap them — Navige now intercepts every tool call
...
if __name__ == "__main__":
    result = executor.invoke({"input": "What is Navige?"})
    print(result["output"])
